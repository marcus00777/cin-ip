...
if carne_misteriosa <=0 or queijo_radioativo <=0 or molho_especial <=0:
    ...
    if carne_misteriosa > queijo_radioativo and carne_misteriosa > molho_especial:
    ...
    elif molho_especial == queijo_radioativo != carne_misteriosa:
         print('Tá tudo girando! Acabamos de criar um Buraco Negro Culinário!')
    elif carne_misteriosa == molho_especial != queijo_radioativo:
         print('Tá tudo girando! Acabamos de criar um Buraco Negro Culinário!')
